      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 w-full">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-3 relative z-10">
            <button className="flex-2 bg-[#1a1a24] hover:bg-black text-white px-8 py-5 rounded-2xl font-bold transition-all flex items-center justify-center gap-3 shadow-lg shadow-black/10 active:scale-[0.98]">
